...
public class ThemeSelectFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        themeArrayList.add(createChinaTheme());
    ...
    Theme createChinaTheme() {
        ArrayList<String> imageUrls = new ArrayList<String>();
        // 40 drawables
        for (int i = 1; i <= 40; i++) {
            imageUrls.add(URI_DRAWABLE + String.format("china_%d", i));
        }
        ...
        return new Theme(4,
                ...
                ResourcesCompat.getDrawable(getContext().getResources(),
                        R.drawable.china_25, getContext().getTheme()),
                R.drawable.china_bg
        );
    }
